...
_legacy_module("sktime.classifiers.elastic_ensemble", "sktime.classification.distance_based._elastic_ensemble")
_legacy_module("sktime.classifiers.time_series_neighbors", "sktime.classification.distance_based._time_series_neighbors")
